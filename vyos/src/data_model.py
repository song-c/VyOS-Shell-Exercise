...
class Vyos(object):
    ...
    def snmp_v3_authentication_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Vyos.SNMP V3 Authentication Protocol'] if 'Vyos.SNMP V3 Authentication Protocol' in self.attributes else None
    ...
    def snmp_v3_authentication_protocol(self, value='No Authentication Protocol'):
        ...
        :type value: str
        """
        self.attributes['Vyos.SNMP V3 Authentication Protocol'] = value
    ...
    def snmp_v3_privacy_protocol(self):
        ...
        :rtype: str
        """
        return self.attributes['Vyos.SNMP V3 Privacy Protocol'] if 'Vyos.SNMP V3 Privacy Protocol' in self.attributes else None
    ...
    def snmp_v3_privacy_protocol(self, value='No Privacy Protocol'):
        ...
        :type value: str
        """
        self.attributes['Vyos.SNMP V3 Privacy Protocol'] = value
