...
### **Vyos**
**Vyos** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Vyos** is based on the Networking Shell Standard version **5.0.4**.
...
The **Vyos** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|Vyos.zip|Device shell package|
|Vyos_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Vyos** shell and configure and modify the shell’s devices.
...
1. Download the *Vyos_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/Vyos/releases).
